...
void CostumeRental::loadCostumes() {
    ...
    if (!inFile) {
        cerr << "Error opening costumes file." << endl;
        return;
    }
...
void CostumeRental::saveCostumes() {
    ...
    if (!outFile) {
        cerr << "Error opening costumes file for writing." << endl;
        return;
    }
...
void CostumeRental::saveCustomersRents() {
    ...
    if (!outFile) {
        cerr << "Error opening customer rents file for writing." << endl;
        return;
    }
